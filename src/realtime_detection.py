...
def realtime_detection(model_path='models/emotion_model.h5', use_vietnamese=True):
    """
    Nhận diện cảm xúc real-time từ webcam
    
    Args:
        model_path: Đường dẫn đến model
        use_vietnamese: Sử dụng tiếng Việt
    """
    print("Đang khởi tạo...")
    ...
    while True:
        ...
        if key == ord('q'):
            ...
            fig = plot_emotion_bar(probabilities, detector.emotions)
            plt.show()
